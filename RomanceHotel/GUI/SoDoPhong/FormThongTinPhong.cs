...
using RomanceHotel.GUI.SoDoPhong;
using System;
...
namespace RomanceHotel.GUI
{
    public partial class FormThongTinPhong : Form
    {
        ...
        {
            FormBackground bg = new FormBackground(formMain);

            try
            {
                using (FormThanhToanTongQuan frm = new FormThanhToanTongQuan(ctdp, taiKhoan, phong, this))
                {
                    bg.Owner = formMain;
                    bg.Show();
                    frm.Owner = bg;
