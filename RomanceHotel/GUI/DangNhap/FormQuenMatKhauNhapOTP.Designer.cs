namespace RomanceHotel.GUI
{
    partial class FormQuenMatKhauNhapOTP
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ButtonContinue = new RomanceHotel.CTControls.CTButton();
            this.textBoxOTP = new RomanceHotel.CTControls.CTTextBox();
            this.ButtonResend = new RomanceHotel.CTControls.CTButton();
