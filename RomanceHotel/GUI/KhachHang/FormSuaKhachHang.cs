...
namespace RomanceHotel.GUI
{
    public partial class FormSuaKhachHang : Form
    {
        ...
        private void LoadForm()
        {
            ...
            this.ctTextBoxEmail.RemovePlaceholder(); // ➜ THÊM
            ...
            this.ctTextBoxEmail.Texts = this.khachHang.Email ?? ""; // ➜ THÊM
        }
        ...
        private void CTButtonCapNhat_Click(object sender, EventArgs e)
        {
                ...
                this.comboBoxGioiTinh.Texts != "  Giới tính")
            {
                ...
                // ➜ KIỂM TRA EMAIL
                string email = ctTextBoxEmail.Texts.Trim();
                if (string.IsNullOrEmpty(email))
                {
                    CTMessageBox.Show("Vui lòng nhập Email của khách hàng.", "Thông báo",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                else if (!email.Contains("@") || !email.Contains("."))
                {
                    CTMessageBox.Show("Email không hợp lệ. Vui lòng kiểm tra lại.", "Thông báo",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
